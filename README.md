...
| `sentence_outlier_test.csv` | The same prediction-interval test applied to the frame:body ratio of mean sentence length, reported in the note to the Table 1 discussion (see §5.6). |
